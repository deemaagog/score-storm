...
test("renders rests (whole, half, quarter) correctly", async ({ page }) => {
  const inputXmlString = fs.readFileSync(path.join(__dirname, "whole-half-quarter-rests.musicxml"), "utf8")
