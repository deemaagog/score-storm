...
test("renders notes (whole, half, quarter) correctly", async ({ page }) => {
  const inputXmlString = fs.readFileSync(path.join(__dirname, "whole-half-quarter-notes.musicxml"), "utf8")
